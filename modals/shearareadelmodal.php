<!-- Modal -->
<div class="modal fade" id="remove_sharearea_modal" tabindex="-1" role="dialog" aria-labelledby="remove_item_modal_Label" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="remove_item_modal_Label">
                    <i class="fa fa-file-text"></i>&nbsp;Remove Item
                </h4>
            </div>
