...
--
-- Host: 127.0.0.1
-- Generation Time: May 09, 2015 at 08:35 PM
...
CREATE TABLE IF NOT EXISTS `action_report` (
  ...
  PRIMARY KEY (`id_action_report`,`admin`),
  KEY `admin_id_key_idx` (`admin`)
...
(12, 4, 'ghak@gmail.com', 'khalfan', '$2y$10$t4355jBuPvFS39ms67pDieRnm9EjH7Fj74jgg5ategKJ9MB9dwOve', '2015-05-09 00:14:04'),
(25, 3, 'khalfan@gmail.com', 'khalfan', '$2y$10$nlcN35jtbaWEWWKHqHYGTu/vNrnnpbVOwPQDaQCxzykQ2ZKJ3z/tG', '2015-05-09 01:47:11'),
(26, 3, 'khalfan@gmail.com', 'khalfan', '$2y$10$356747kx51VzBur5143bBu5b/uIxDu.bjr2E2linviCAy973RQ4wu', '2015-05-09 01:48:17');
...
INSERT INTO `feadback` (`feadback_id`, `feadback_user_id`, `feadback_add_date`, `feadback_text`) VALUES
(4, 4, '2015-05-08 19:00:06', ' feadback_text feadback_text feadback_text feadback_text feadback_text'),
(5, 4, '2015-05-08 19:00:06', ' feadback_text feadback_text feadback_text feadback_text feadback_text'),
(6, 4, '2015-05-08 19:00:06', ' feadback_text feadback_text feadback_text feadback_text feadback_text'),
(7, 4, '2015-05-08 19:00:16', ' feadback_text feadback_text feadback_text feadback_text feadback_text'),
(8, 4, '2015-05-08 19:00:20', ' feadback_text feadback_text feadback_text feadback_text feadback_text'),
(9, 4, '2015-05-08 19:00:22', ' feadback_text feadback_text feadback_text feadback_text feadback_text');
...
--
-- Table structure for table `nav_tab_title`
--

CREATE TABLE IF NOT EXISTS `nav_tab_title` (
  `nav_tab_title_id` int(11) NOT NULL AUTO_INCREMENT,
  `navkey` varchar(100) NOT NULL,
  `title` varchar(100) NOT NULL,
  `creator_admin` int(11) NOT NULL,
  PRIMARY KEY (`nav_tab_title_id`,`creator_admin`),
  KEY `nav_tab_title_admin_key_idx` (`creator_admin`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=28 ;

--
-- Dumping data for table `nav_tab_title`
--

INSERT INTO `nav_tab_title` (`nav_tab_title_id`, `navkey`, `title`, `creator_admin`) VALUES
(1, 'placetitle', 'Place', 2),
(2, 'placenew', 'New', 2),
(7, 'placelist', 'List', 2),
(8, 'placesearch', 'Search', 2),
(9, 'souvenirtitle', 'Souvenirs', 2),
(10, 'newsouvenir', 'New Souvenirs', 2),
(11, 'listsouvenirtitle', 'List Souvenirs', 2),
(12, 'searchsouvenir', 'Souvenirs Search', 2),
(13, 'commintsouvenir', 'Souvenirs Commint', 2),
(20, 'servicestitle', 'Services', 2),
(21, 'services', 'Services', 2),
(22, 'servicesproviders', 'Services Providers', 2),
(23, 'Servicesrequests', 'Services Requist', 2),
(26, 'sheararea', 'Shear Area', 2),
(27, 'feedback', 'User Feeback', 2);
...
CREATE TABLE IF NOT EXISTS `notifications` (
  `noti_id` int(5) NOT NULL AUTO_INCREMENT,
  `noti_text` text NOT NULL,
  `noti_adddate` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`noti_id`)
...
CREATE TABLE IF NOT EXISTS `place_image` (
  `place_image_id` int(11) NOT NULL AUTO_INCREMENT,
  `place_id` int(11) NOT NULL,
  `image_title` tinytext NOT NULL,
  `image_path` tinytext NOT NULL,
  PRIMARY KEY (`place_image_id`,`place_id`),
  KEY `place_image_place_id_key_idx` (`place_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=16 ;
...
CREATE TABLE IF NOT EXISTS `service_rate` (
  ...
  PRIMARY KEY (`service_rate_id`,`user_id`,`service_id`),
  KEY `service_rate_service_id_idx` (`service_id`),
  KEY `service_rate_user_id_key_idx` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `share_area`
--

INSERT INTO `share_area` (`sharearea_id`, `sharearea_text`, `sharearea_user_id`, `sharearea_image`, `sharearea_add_date`, `sharearea_location`) VALUES
(2, 'sharearea_text sharearea_text sharearea_text', 2, NULL, '2015-05-08 18:56:55', '23423423'),
(4, 'sharearea_text sharearea_text sharearea_text', 2, NULL, '2015-05-08 18:56:56', '23423423');
...
CREATE TABLE IF NOT EXISTS `user_service_rate` (
  ...
  PRIMARY KEY (`user_service_rate_id`,`user_id`,`user_service_id`),
  KEY `user_service_rate_user_service_id_key_idx` (`user_service_id`),
  KEY `user_service_rate_user_id_key_idx` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Constraints for table `nav_tab_title`
--
ALTER TABLE `nav_tab_title`
  ADD CONSTRAINT `nav_tab_title_admin_key` FOREIGN KEY (`creator_admin`) REFERENCES `admin` (`admin_id`) ON DELETE CASCADE ON UPDATE CASCADE;
