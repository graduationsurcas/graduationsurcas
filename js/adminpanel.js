...
$(document).ready(function () {
    ...
    $("#form-add-new-admin").submit(function (event) {
        ...
        var url = sitelink + "/server/servecerequests.php";
        Data = {
                'destination': 'enternewadmin',
                'new-admin-type': $('#new-admin-type').val(),
                'new-admin-name': $('input[id=new-admin-name]').val(),
                'new-email-email': $('input[id=new-admin-email]').val(),
                'new-admin-password': $('input[id=new-admin-password]').val()
            };
        $.ajax({
            type: 'POST',
                url: url,
            ...
            beforeSend: function (xhr) {
                console.log(Data)
                $("fa fa-spin fa-cog").show();
                $("#form-add-new-admin :input").prop("disabled", true);
            },
            success: function (data, textStatus, jqXHR) {
                if (data.status == "true") {
                    $('#form-add-new-admin-message').text("admin is Entered ");
                } else {
                    $('#form-add-new-admin-message').text("Some unknown error happened");
                }
                document.getElementById("form-add-new-admin").reset();
                $(".submit-form-spinner").hide();
                $("#form-add-new-admin :input").prop("disabled", false);

            },
            error: function (jqXHR, textStatus, errorThrown) {
                $("#form-add-new-admin :input").prop("disabled", false);
                $('#form-add-new-admin-message').text("Some error happened, " + errorThrown);
            }
        });
        event.preventDefault();
    });
 ...
 $("#form-add-new-item-type").submit(function (event) {
        ...
        var url = sitelink + "/server/servecerequests.php";
        Data = {
                'destination': 'enternewitemtype',
                'new-item-type': $('#new-item-type').val()
            };
        $.ajax({
            type: 'POST',
                url: url,
            ...
            beforeSend: function (xhr) {
                $("fa fa-spin fa-cog").show();
                $("#form-add-new-item-type :input").prop("disabled", true);
            },
            success: function (data, textStatus, jqXHR) {
                if (data.status == "true") {
                    $('#form-add-new-item-message').text("Souvenir is Entered ");
                } else {
                    $('#form-add-new-item-message').text("Some unknown error happened");
                }
                document.getElementById("form-add-new-admin").reset();
                $(".submit-form-spinner").hide();
                $("#form-add-new-item-type :input").prop("disabled", false);
    ...
    $("#form-add-new-services-type").submit(function (event) {
        $(".submit-form-spinner").hide();
        var url = sitelink + "/server/servecerequests.php";
        Data = {
                'destination': 'enternewservicestype',
                'new-services-type': $('#new-services-type').val()
            };
        $.ajax({
            type: 'POST',
                url: url,
            ...
            beforeSend: function (xhr) {
                $("fa fa-spin fa-cog").show();
                $("#form-add-new-services-type :input").prop("disabled", true);
            },
            success: function (data, textStatus, jqXHR) {
                if (data.status == "true") {
                    $('#form-add-new-services-message').text("Service is Entered ");
                } else {
                    $('#form-add-new-services-message').text("Some unknown error happened");
                }
                document.getElementById("form-add-new-admin").reset();
                $(".submit-form-spinner").hide();
                $("#form-add-new-services-type :input").prop("disabled", false);

            },
            error: function (jqXHR, textStatus, errorThrown) {
                $("#fform-add-new-services-type :input").prop("disabled", false);
                $('#form-add-new-services-message').text("Some error happened, " + errorThrown);
            }
        });
        event.preventDefault();
    });
...
$("#form-add-new-place-type").submit(function (event) {
        $(".submit-form-spinner").hide();
        var url = sitelink + "/server/servecerequests.php";
        Data = {
                'destination': 'enternewplacetype',
                'new-place-name': $('#new-place-name').val()
            };
        ...
        $.ajax({
            ...
            success: function (data, textStatus, jqXHR) {
                if (data.status == "true") {
                    $('#form-add-new-places-message').text("Place is Entered ");
                } else {
